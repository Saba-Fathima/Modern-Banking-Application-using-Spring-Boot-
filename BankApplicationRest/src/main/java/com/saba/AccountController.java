...
@Controller
public class AccountController<TransferDetails, AmountResult> {
	...
	{
		Object balance = service.depositAmount(account_no,name,password,amount);
		if(balance != null)
		{
	...
	{
		Object balance = service.withdrawAmount(account_no,name,password,amount);
		if(balance != null)
		{
	...
	{
		com.saba.TransferDetails account = service.transferAmount(account_no,name,password,targetAccount,amount);
		if(account != null)
		{
